...
print(f"Datasets directory: {os.path.join(CURRENT_DIR, 'datasets')}")

print("\n===== Dataset Configuration =====")
# CONFIGURATION: Random sampling with fixed numbers per person
# - Randomly sample 20 images per person from available images
# - Use 4 images for training, 16 images for testing
# This ensures balanced dataset across all people regardless of original image count

print("Configuration: Random sampling - 20 images per person (4 training, 16 testing)")
print("="*50)
...
print("Total Train Images:", len(images_names))
print("Total Test Images:", len(images_names_for_test))
...
import pickle
model_save_path = os.path.join(MODELS_DIR, "pca_model.pkl")
